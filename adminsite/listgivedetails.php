                ...
                <div class="container bootstrap snippets bootdey">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                        ...
                                        <table class="table user-list" style="margin-bottom: 0%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; color: black; font-weight: bold; font-size: 18px; border: 2px solid rgb(194, 194, 194);"><span>จำนวน</span></th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="border: 2px solid rgb(194, 194, 194); ">
                                                        <span class="user-link1" style="color: black;">3</span>
                                                    </td>
                                                    <td style="border: 2px solid rgb(194, 194, 194); ">
                            ...
                            <div>
                                <button class="onbutton" type="button">ยืนยันคืนอุปกรณ์</button>
                            </div>
                        </div>
                    </div>
                </div>
