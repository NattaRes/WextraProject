    ...
    <div class="container mt-10 p-3 cart" style="margin-top: 1%; background-color: #F6F6F6; border-radius: 30px; margin-bottom: 4%; margin-left: 13%;">
        <div class="payment-info">
            ...
            <div><label class="credit-card-label" style="margin-left: 5%; font-size: 18px; color: #7E7C7C;">วันที่ยืม :</label>
                <input style=" color: #7E7C7C;  border-radius:5px; background:#D9D9D9; border:none; width: 15%;" type="date" />
            ...
            <div>
                ...
                <select style=" color: #7E7C7C;  border-radius:5px; background:#D9D9D9; border:none; width: 15%;">เลือก
                    <option>1.</option>
                    <option>2.</option>
                    <option>3.</option>
                </select>
            ...
            <div><label class="credit-card-label" style="margin-left: 5%; font-size: 18px; color: #7E7C7C;">หมายเหตุ :</label>
                <input type="text" style=" color: #7E7C7C;  border-radius:10px; background:#D9D9D9; border:none; width: 25%; height: 5%;" placeholder="ใช้ทำในงานอะไร" />
            </div>
        </div>
        <div>
            ...
            <div class="container bootstrap snippets bootdey">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div>
                            <a href="status.html">
                                <button class="onbutton" type="button">ส่งคำอนุมัติ</button>
                            </a>
                        </div>
                    </div>
                </div>
