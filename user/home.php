...
<body style=" margin-bottom: 10%;">
  ...
  <div style="margin-top: 15%;">
    ...
    <div class="row">
      <div class="column">
        <div class="one">
          <a href="Alltools.php?sinput=&tpin=1" class="bt">
     ...
     -->
      <div class="column">
        <div class="three">
          <a href="Alltools.php?sinput=&tpin=2" class="bt" style="margin-left: 0%;">
      ...
      <div class="column">
        <div class="four">
          <a href="Alltools.php?sinput=&tpin=4" class="bt" style="margin-left: 2%;">
      ...
      <div class="column">
        <div class="five">
          <a href="Alltools.php?sinput=&tpin=other" class="bt" style="margin-left: 3%;">
            <img src="../image/icon/support.png" alt="" class="iconimg">
            <h4 class="titlect">อื่น ๆ</h4>
          </a>
        </div>
      </div>
    </div>
